                        ...
                        <div class='card-body'>
                            ...
                            <?php if ($parent != "") : ?>
                                <a href="?page=explorer&folder=<?= $parent?>" style="text-decoration: none; margin: 10px;"> 
                                    <img src='./img/retour.jpg' width='50' height='50'> Retour 
                                </a>
                            <?php else : ?>
                    ...
                    <div class='card'>
                        <div class='card-body'>
                            ...
                            <?php if (is_dir($fullPath)) : ?>
                                ...
                                <a href="?page=explorer&folder=<?= $fullPath?>" style="text-decoration: none;"> <img src='./img/folder2.png' width='50' height='50'> <?= $file; ?> </a>

                            <?php else : ?>

                                <img src='./img/file2.png' width='50' height='50'>
                                <?= $file; ?>
